...
function smarty_function_admin_ariane($params, &$smarty){
	...
	$segment = explode('/', $url);
	$root = magixcjquery_html_helpersHtml::getUrl().DIRECTORY_SEPARATOR;
	$fil = null;
	$fil .= empty($segment[2])? null: '<li><a href="'.$root.$segment[0].$segment[1].DIRECTORY_SEPARATOR.$segment[2].'"><span style="float:left;" class="ui-icon ui-icon-home"></span></a></li>';
