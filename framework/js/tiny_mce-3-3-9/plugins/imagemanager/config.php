<?php
	...
	$tinymce_array_dir = array('framework'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'tiny_mce-3-3-9'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'imagemanager');
