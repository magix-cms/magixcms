 ...
 * @name ns_jsettingeditor
 * @update 10/10/2011 23:15
 */
var ns_jsettingeditor = {
	...
	_updateEditor:function(){
		 ...
		 */
		$(".list-editor a").live("click", function(e){
			e.preventDefault();
			...
			if(hreftitle != null){
				...
				$.nicenotify({
					ntype: "ajax",
					uri: "/admin/editor.php?htmleditor=true",
					typesend: 'post',
					noticedata : "editor="+hreftitle,
	...
	_updateSubConfig:function(){
		$("#manager-editor-settings :radio").click(function(){
			...
			$.nicenotify({
				...
				uri: '/admin/editor.php?manager_editor_setting=true',
				typesend: 'post',
				idforms: '#manager-editor-settings',
				successParams:function(e){
					$.nicenotify.initbox(e,{
						display:false
					});
