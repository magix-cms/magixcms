...
$(function() {
	$.getScript('/framework/js/tiny_mce/jquery.tinymce.js', function() {
		$('.mceEditor').tinymce({
			...
			theme : "advanced",
			plugins : "safari,xhtmlxtras,inlinepopups,advlink,advimage,insertdatetime,style,layer,table,fullscreen,contextmenu,paste,preview,rj_insertcode,tablegrid,youtube,cmspage,loremipsum,productsearch"+manager_tinymce_plugin,
			// Theme options
			...
			theme_advanced_buttons3 : "tablegrid,|,row_props,cell_props,|,row_before,row_after,delete_row,|,col_before,col_after,delete_col,|,split_cells,merge_cells,|,tabledraw,convertcelltype,|,hr,removeformat,|,rj_insertcode,loremipsum,youtube,cmspage,productsearch",
