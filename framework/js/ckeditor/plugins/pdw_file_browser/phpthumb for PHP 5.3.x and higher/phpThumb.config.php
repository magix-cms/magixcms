...
ob_end_clean();
$ckeditor_pdw_thumb_dir = dirname(realpath( __FILE__ ));
$ckeditor_pdw_thumb_array_dir = array('framework'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'ckeditor'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'pdw_file_browser'.DIRECTORY_SEPARATOR.'phpthumb for PHP 5.3.x and higher');
$ckeditor_pdw_thumb = str_replace($ckeditor_pdw_thumb_array_dir,array('var'.DIRECTORY_SEPARATOR.'pdw_file_cache') , $ckeditor_pdw_thumb_dir);
...
$PHPTHUMB_CONFIG['cache_directory'] = $ckeditor_pdw_thumb;
