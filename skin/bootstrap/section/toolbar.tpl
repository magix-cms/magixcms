{strip}
    ...
    {/if}
{/strip}
    <section id="toolbar" class="clearfix{if $adjust == 'fluid'} section-block container-fluid{/if}" itemprop="copyrightHolder" itemscope itemtype="http://schema.org/{$companyData.type}"{if $companyData.tva} itemref=" tva"{/if}>
        ...
        {if $adjust == 'clip'}<div class="container">{/if}
            ...
            {/if}
            {/if}
            <div id="contact-infos" class="hidden-xs-down">
            ...
            {if $companyData.contact.phone}
                <div class="hidden-sm-up pull-right">
                    <ul>
                        <li>
                            <a data-toggle="collapse" href="#contact-phone" aria-expanded="false" aria-controls="contact-phone">
