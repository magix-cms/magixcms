...
{block name='article'}
    <article id="article" class="container catalog" itemprop="mainEntity" itemscope itemtype="http://schema.org/Product">
        {block name='article:content'}
            <div class="row">
                <div id="product-info" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 text-center">
                    {widget_catalog_data
                        conf =[
                                ...
                                <div class="big-image">
                                    <a id="default" class="img-gallery" href="{$product.imgSrc.large}" rel="productGallery" title="{$product.name}" itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
                                        ...
                                        <span itemprop="thumbnail" itemscope itemtype="http://schema.org/ImageObject">
                                            <img itemprop="image" src="{$product.imgSrc.small}" alt="{$product.name|ucfirst}" itemprop="contentUrl"/>
                                        </span>
                                    </a>
                                    ...
                                    <a id="img{$k}" class="img-gallery" href="{$item.imgSrc.medium}" rel="productGallery" title="{$product.name}" itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
                                        ...
                                        <span itemprop="thumbnail" itemscope itemtype="http://schema.org/ImageObject">
                                            <img itemprop="image"  src="{$item.imgSrc.small}" alt="{$product.name|ucfirst}" itemprop="contentUrl"/>
                                        </span>
                                    </a>
                                    {/foreach}
                                </div>
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a class="show-img" href="#" data-target="#default">
                                                <img src="{$product.imgSrc.small}" alt="{$product.name|ucfirst}"/>
                                            </a>
                                        </li>
                                        {foreach $galeryProductData as $k => $item}
                                        <li>
                                            <a class="show-img" href="#"  data-target="#img{$k}" rel="productGallery">
                                                <img src="{$item.imgSrc.small}" alt="{$product.name|ucfirst}"/>
                                            </a>
                                        </li>
                                        {/foreach}
                                    </ul>
                        ...
                        <figure{if $product.imgSrc.medium} itemprop="image" itemscope itemtype="http://schema.org/ImageObject"{/if}>
                            {if $product.imgSrc.medium}
                                ...
                                <a href="{$product.imgSrc.large}" class="img-zoom" title="{$product.name}" itemprop="thumbnail" itemscope itemtype="http://schema.org/ImageObject">
                                    <img src="{$product.imgSrc.medium}" alt="{$product.name}" itemprop="contentUrl"/>
                                </a>
                            {else}
                ...
                <div class="content col-xs-12 col-sm-7 col-md-8 col-lg-9">
                    <header>
            ...
            {if $productRel != null}
                <section id="similar-products">
                    ...
                    <div class="product-list row">
                        {include file="catalog/loop/product.tpl" effect="ming" data=$productRel classCol="col-xs-12 col-sm-6 col-md-4 col-xl-3" similar=true}
                    </div>
                </section>
            {/if}
        {/block}
