    ...
    {/if}
    <header>
        <div id="org" itemprop="copyrightHolder" itemscope itemtype="http://schema.org/{$companyData.type}" {if $companyData.tva}itemref="tva"{/if}>
            {if $toolbar}
            ...
            <section id="header" role="navigation"{if $adjust == 'fluid'} class="section-block container-fluid"{/if}>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        {include file="section/menu/primary.tpl" id="nav-primary-collapse" type=$menu root=['home'=>true,'catalog'=>true,'news'=>true,'contact'=>true] gmap=false justified=false}
                        {if $adjust == 'clip'}
                    </div>
                </div>
                {/if}
            ...
            <section id="header-fixed" role="navigation" data-spy="affix" data-offset-top="71"{if $adjust == 'fluid'} class="section-block container-fluid"{/if}>
                ...
                <div class="container">
                    ...
                    {include file="section/menu/primary.tpl" id="nav-primary-fixed" type=$menu root=['home'=>true,'catalog'=>true,'news'=>true,'contact'=>true] gmap=false justified=false}
                        {if $adjust == 'clip'}
                    </div>
                </div>
                {/if}
