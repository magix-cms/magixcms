    ...
    <tr id="opening_{$day}">
        ...
        <td>
            <div class="input-group open_hours">
                <label for="{$day}-op-h" class="sr-only">Hours</label>
                ...
                <label for="{$day}-op-m" class="sr-only">Minutes</label>
        ...
        <td>
            <div class="input-group open_hours">
                <label for="{$day}-cl-h" class="sr-only">Hours</label>
                ...
                <span class="input-group-addon">:</span>
                <label for="{$day}-cl-m" class="sr-only">Minutes</label>
        ...
        <td>
            <div class="input-group noon_hours">
                <label for="{$day}-ns-h" class="sr-only">Hours</label>
                ...
                <span class="input-group-addon">:</span>
                <label for="{$day}-ns-m" class="sr-only">Minutes</label>
        ...
        <td>
            <div class="input-group noon_hours">
                <label for="{$day}-ne-h" class="sr-only">Hours</label>
                ...
                <span class="input-group-addon">:</span>
                <label for="{$day}-ne-m" class="sr-only">Minutes</label>
