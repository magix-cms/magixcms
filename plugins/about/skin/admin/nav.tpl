<nav class="navbar navbar-default">
    ...
    <div id="about-navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li>
                <a href="{$pluginUrl}&amp;tab=page"><span class="fa fa-file-text-o"></span> {#page_admin#|ucfirst}</a>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="pull-right">
                <a href="{$pluginUrl}&amp;tab=about"><span class="fa fa-info-circle"></span> {#plugin_about#|ucfirst}</a>
            </li>
        </ul>
    </div>
</nav>