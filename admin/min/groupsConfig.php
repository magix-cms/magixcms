...
return array(
	'adminjs' =>    array(
        ...
        '//libjs/plugins/jquery.form.3.40.min.js',
        '//libjs/plugins/jquery.validate.1.11.1.min.js',
        '//libjs/plugins/additional-methods.1.11.1.min.js',
        '//'.PATHADMIN.'/template/js/plugins/bootstrap.3.0.0.min.js',
	...
	'jimagine' =>   array(
        ...
        '//'.PATHADMIN.'/template/js/plugins/jquery.fancybox.js',
    ...
    'charts'    =>  array(
        '//'.PATHADMIN.'/template/js/plugins/raphael-min.js',
        '//'.PATHADMIN.'/template/js/plugins/morris.min.js'
    ),
    'tinymce' => array(
        '//'.PATHADMIN.'/template/js/tiny_mce.'.VERSION_EDITOR.'/jquery.tinymce.min.js'
    ),
    'css' => array(
        '//'.PATHADMIN.'/template/css/bootstrap.3.0.0.min.css',
        ...
        '//'.PATHADMIN.'/template/css/style.css'
    ),
    'maxAge' => 31536000,
