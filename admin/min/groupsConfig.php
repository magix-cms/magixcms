...
return array(
    ...
    '//framework/plugins/jquery.fancybox.min.js','//'.PATHADMIN.'/template/js/setting.js'),
    ...
    '//'.PATHADMIN.'/template/css/ui-bootstrap/jquery-ui-1.9.2.custom.css','//'.PATHADMIN.'/template/css/fancybox/jquery.fancybox.css','//'.PATHADMIN.'/template/css/style.css'),
    'maxAge' => 31536000,
