            ...
            <div class="form-group">
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="key" id="ws_key" name="ws_key" value="" size="50">
        ...
        <div class="clearfix">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <div class="checkbox">
                        <label>
                            <input {if $data.status_key eq '1'} checked{/if} type="checkbox" name="status_key" id="status_key" value="1" data-toggle="toggle" data-on="oui" data-off="non" data-onstyle="primary" data-offstyle="default">
                        </label>
                    </div>
                </div>
            </div>
