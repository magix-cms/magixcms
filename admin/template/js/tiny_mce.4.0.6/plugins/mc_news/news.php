...
<html lang="en">
  ...
  <link href="/<?php print PATHADMIN; ?>/template/css/bootstrap.3.0.0.min.css" rel="stylesheet">
  <link href="./css/mc_news.css" rel="stylesheet">
  ...
  <body>
   <div class="container">
        ...
        <div id="list-news-search" class="row"></div>
    </div>
  ...
  <script src="/<?php print PATHADMIN; ?>/template/js/plugins/bootstrap.3.0.0.min.js"></script>
  ...
  <script src="./js/mc_news.js"></script>
  </body>
</html>