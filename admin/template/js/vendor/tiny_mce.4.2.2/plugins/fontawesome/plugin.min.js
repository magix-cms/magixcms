...
tinymce.PluginManager.add('fontawesome', function (editor, url) {
    ...
    function showDialog() {
            ...
            for (y = 0; y < (iconGroup.length / width); y++) {
                ...
                for (x = 0; x < width; x++) {
                    if (iconTitle === 'Spinner') {
                        gridHtml += '<td><span class="fa fa-spin ' + iconGroup[y * width + x] + '"></span></td>';
                    }
                    else {
                        gridHtml += '<td><span class="fa ' + iconGroup[y * width + x] + '"></span></td>'
        ...
        var panelHtml = groupHtml(ListIcons, translate('Icons List'));
    ...
    editor.on('init', function() {
        ...
        var csslinkFA = editor.dom.create('link', {
            rel: 'stylesheet',
            href: url + '/css/font-awesome/font-awesome.min.css'
        });
        document.getElementsByTagName('head')[0].appendChild(csslinkFA);
    });
